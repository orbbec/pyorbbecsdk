...
All notable changes to pyorbbecsdk will be documented in this file.
...
## [2.0.18] — v2-main branch

### Overview

This is the initial changelog entry for the **v2-main** branch (SDK v2.x series).
