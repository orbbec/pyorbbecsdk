...
|------|----------------|-------|
| CMake | 3.15 | |
| Python | 3.9+ | 3.10 recommended for running the full test suite |
| pybind11 | 2.11.0 | Install via pip: `pip install pybind11==2.11.0 pybind11-global==2.11.0` |
...
Output wheel: `dist/pyorbbecsdk2-2.0.18-*.whl`
...
- Your device firmware meets the minimum version in [README.md — Hardware Products](README.md#hardware-products-supported-by-python-sdk).
