...
#    2. Write the preset data to the device using the update API
#    3. Monitor the update progress via a state/percentage callback
#    4. Verify the updated presets are available after the write completes
#
