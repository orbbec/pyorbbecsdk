# ******************************************************************************
#  pyorbbecsdk Advanced Example — Hardware Depth-to-Color (D2C) Alignment
#
#  What you will learn:
#    1. Enable on-device hardware D2C alignment via pipeline configuration
#    2. Compare hardware alignment (lower CPU) vs software AlignFilter
#    3. Toggle between SW and HW alignment modes at runtime
#    4. Visualize the aligned depth overlaid on the color stream
#
#  Device requirement: All
#
#  Run:
#    python examples/advanced/hw_d2c_align.py
# ******************************************************************************
