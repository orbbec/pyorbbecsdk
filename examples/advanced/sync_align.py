# ******************************************************************************
#  pyorbbecsdk Advanced Example — Software Depth-to-Color Alignment
#
#  What you will learn:
#    1. Configure and run AlignFilter in software to align depth to color
#    2. Set the target alignment stream via OBStreamType
#    3. Display the aligned depth and color frames side by side
#    4. Control the viewer with keyboard input (ESC to quit)
#
#  Keyboard controls:
#    ESC — exit
#
...
#
#  Run:
#    python examples/advanced/sync_align.py
# ******************************************************************************
import sys
import os
