# ******************************************************************************
#  pyorbbecsdk Application Example — Real-Time Object Detection with Depth
#
#  What you will learn:
#    1. How to run a YOLO ONNX model on the aligned color stream in real time
#    2. How to use AlignFilter to map detected bounding boxes to depth values
#    3. How to filter out-of-range depth readings and display distance per object
#    4. How to overlay bounding boxes, class labels, and depth on the color image
#
