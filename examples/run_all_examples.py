...
TESTS = [
    # ---- Beginner ----
    ("01 hello_camera",
     "examples/beginner/01_hello_camera.py", [], None),

    ("02 depth_visualization",
     "examples/beginner/02_depth_visualization.py", [], None),

    ("03 color_and_depth_aligned (SW)",
     "examples/beginner/03_color_and_depth_aligned.py", [], None),

    ("03 color_and_depth_aligned (HW --hw)",
     "examples/beginner/03_color_and_depth_aligned.py", ["--hw"], None),

    ("04 camera_calibration",
     "examples/beginner/04_camera_calibration.py", [], None),

    ("05 point_cloud",
     "examples/beginner/05_point_cloud.py", [], None),

    ("06 multi_streams",
     "examples/beginner/06_multi_streams.py", [], None),

    ("07 imu",
     "examples/beginner/07_imu.py", [], None),
    ...
    ("adv01 recorder (--no-gui)",
     "examples/advanced/01_recorder.py", ["--no-gui"],
    ...
    ("adv03 save_image_to_disk",
     "examples/advanced/03_save_image_to_disk.py", [], None),

    ("adv04 enumerate",
     "examples/advanced/04_enumerate.py", [], b"q\n"),

    ("adv05 hot_plug",
     "examples/advanced/05_hot_plug.py", [], None),

    ("adv06 control",
     "examples/advanced/06_control.py", [], None),

    ("adv07 metadata",
     "examples/advanced/07_metadata.py", [], None),

    ("adv08 custom_filter_chain",
     "examples/advanced/08_custom_filter_chain.py", [], None),

    ("adv09 post_processing",
     "examples/advanced/09_post_processing.py", [], None),

    ("adv10 hdr",
     "examples/advanced/10_hdr.py", [], None),

    ("adv11 preset",
     "examples/advanced/11_preset.py", [], b"-1\n"),

    ("adv12 depth_work_mode",
     "examples/advanced/12_depth_work_mode.py", [], None),

    ("adv13 confidence",
     "examples/advanced/13_confidence.py", [], None),
    ...
    ("adv15 high_performance_pipeline",
     "examples/advanced/15_high_performance_pipeline.py", [], None),

    ("adv16 coordinate_transform",
     "examples/advanced/16_coordinate_transform.py", [], None),

    ("adv17 laser_interleave",
     "examples/advanced/17_laser_interleave.py", [], None),
    ...
    # ---- Applications ----
    ("app ruler",
     "examples/applications/ruler.py", [], None),
