 ...
 * @return ob_sensor_type returns the source sensor type of the ir frame
 */
 ...
 * @param[in] system_timestamp system timestamp to be set
 * @param[out] error Log error messages
 */
 ...
 *
 * @param[in] frame object for frame settings
 * @param[in] device_timestamp device timestamp to be set
 * @param[out] error Log error messages
 */
