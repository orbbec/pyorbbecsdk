...
typedef enum {
    ...
    OB_PROP_TIMER_RESET_TRIGGER_OUT_ENABLE_BOOL = 105, /**<  Enable send reset device time signal to other device. true: enable, false: disable
                                                        */
    ...
    /**
     * @brief Get hardware laser energy level which real state of laser element. OB_PROP_LASER_ENERGY_LEVEL_INT（99）will effect this command which it
    ...
    OB_PROP_CAPTURE_INTERVAL_MODE_INT         = 134, /**< Capture interval mode, 0:time interval, 1:number interval */
    OB_PROP_CAPTURE_IMAGE_TIME_INTERVAL_INT   = 135, /**< Capture time interval */
    OB_PROP_CAPTURE_IMAGE_NUMBER_INTERVAL_INT = 136, /**< Capture number interval */

    /**
     * @brief  Device development mode switch, optional modes can refer to the definition in @ref OBDeviceDevelopmentMode,the default mode is @ref OB_USER_MODE
     * @attention The device takes effect after rebooting when switching modes.
     */
    OB_PROP_DEVICE_DEVELOPMENT_MODE_INT  = 129,
    OB_PROP_SYNC_SIGNAL_TRIGGER_OUT_BOOL = 130, /**< Multi-DeviceSync synchronized signal trigger out is enable state. true: enable, false: disable */
    ...
    /**
     * @brief Query current device usb port status (read-only)
     */
    OB_PROP_USB_STATUS_CHECK_BOOL = 144,
    ...
    OB_PROP_COLOR_SHUTTER_INT                = 2007, /**< Color camera shutter adjustment */
    ...
    OB_PROP_COLOR_MAXIMAL_GAIN_INT    = 2030, /**< Color camera maximal gain */
    OB_PROP_COLOR_MAXIMAL_SHUTTER_INT = 2031, /**< Color camera shutter gain */
