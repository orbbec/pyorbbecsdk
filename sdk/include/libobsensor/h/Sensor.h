 ...
 *
 * @param[in] sensor_list  List of sensor objects to delete
 * @param[in] index index of sensor on the list
 * @param[out] error Log error messages
 *
 ...
 *
 * @param[in] sensor_list Get the returned sensor list through device
 * @param[in] sensorType  Sensor type to be obtained
 * @param[out] error Log error messages
 *
