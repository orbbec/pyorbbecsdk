 ...
 *
 * @param[in] profile_list Resolution list
 * @param[in] fullScaleRange fullScaleRange, if you don't need to add matching conditions, you can pass 0
 * @param[in] sampleRate sampleRate, if you don't need to add matching conditions, you can pass 0
 * @param[out] error Log error messages
 * @return ob_stream_profile* returns the matching profile
 */
