...
public:
     ...
     * @param strideBytes frame strideBytes; if strideBytes > 0, frame data size = height * strideBytes; if strideBytes = 0, frame data size = height * width *
     * pixelSize
...
public:
     ...
     * @param[in] frameWidth frame object width
     * @param[in] frameHeight frame object height
     * @param[in] buffer frame object buffer
     * @param[in] bufferSize frame object buffer size
     * @param[in] destroyCallback frame object buffer destroy callback
     * @param[in] destroyCallbackContext frame object buffer destroy callback context
     *
